...
class GroupVAEBase(BaseVAE):
    ...
    def _compute_losses_weak(self, x_1, x_2, is_training, labels):
        ...
        reconstructions_1 = self.decoder(z_sampled_1, training=is_training)
        reconstructions_2 = self.decoder(z_sampled_2, training=is_training)
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            reconstruction_loss, regularizer, loss, elbo = \
                self._compute_losses_weak(x_1, x_2, is_training, labels)
