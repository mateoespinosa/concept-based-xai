...
'''
A primer on bases:
Assume you have a vector A = (x, y, z), where every dimension is in base
(a, b, c). Then, in order to convert each of those dimensions to decimal, we do:
